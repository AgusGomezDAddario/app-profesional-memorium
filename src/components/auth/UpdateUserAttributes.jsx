...
export const UpdateUser = () => {
  ...
  async function handleUpdatePassword(oldPassword, newPassword) {
    if (!oldPassword || !newPassword) {
      setSuccess("");
      setError(
        "Por favor, ingrese la contraseña actual y la nueva contraseña."
      );
      return;
    }
    try {
  ...
  return (
    ...
    >
      <CardHeader
        sx={{ "& .MuiTypography-root": { fontFamily: "Gentium Plus, serif" } }}
      ...
      <CardContent>
        <Form>
          <Box>
            ...
            <p>
              La contraseña debe contener al menos: 8 caracteres, 1 número y una
              mayúscula
            </p>
            <p>La matrícula debe contener 8 dígitos</p>
            {error && (
              <h5 style={{ fontFamily: "Gentium Plus, serif", color: "red" }}>
                {error}
              </h5>
            )}
            {success && (
              <h5 style={{ fontFamily: "Gentium Plus, serif", color: "green" }}>
                {success}
              </h5>
            )}
          </Box>
