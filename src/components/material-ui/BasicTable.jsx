        ...
        <TableContainer component={Paper}>
          <Table sx={{ minWidth: 650 }} size="small" aria-label="a dense table">
            <TableHead className='header'>
              <TableRow>
                <TableCell align="center" sx={{ color: 'white', fontSize: '1.2rem', fontFamily: 'Gentium Plus' }}>Número de Partida</TableCell>
                ...
                <TableCell align="center" sx={{ color: 'white', fontSize: '1.2rem', fontFamily: 'Gentium Plus' }}>Tiempo (segundos)</TableCell>
            ...
            <TableBody>
              {pacienteProfile.historial &&
                pacienteProfile.historial
                  ...
                  .flatMap(historial => historial.partidas.map((partida, index) => (
                    <TableRow
                      key={index}
                    ...
                    >
                      ...
                      <TableCell align="center">{partida.facilitaciones}</TableCell>
                    </TableRow>
                  )))}
            </TableBody>
          </Table>
