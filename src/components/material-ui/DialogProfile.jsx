      ...
      >
        ...
        >
          <DialogContentText id="alert-dialog-slide-description">
            <p>
              <strong>Nombre:</strong> {userInformation.given_name}
            </p>
            <p>
              <strong>Apellido:</strong> {userInformation.family_name}
            </p>
            <p>
              <strong>Email:</strong> {userInformation.given_name}
            </p>
            <p>
              <strong>Residencia:</strong> {userInformation.address}
            </p>
            <p>
              <strong>Nacimiento:</strong> {userInformation.birthdate}
            </p>
            <p>
              <strong>Matricula:</strong> {userInformation.matricula}
            </p>
            <p>
              <strong>Pacientes:</strong> 1
            </p>
          </DialogContentText>
        </DialogContent>
        <DialogActions>
