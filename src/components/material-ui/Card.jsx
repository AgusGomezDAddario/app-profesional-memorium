...
export const cardPacientes = (
    <React.Fragment>
        <CardContent sx={{ backgroundColor: '#2f5496', borderTop: '1px solid white', borderLeft: '1px solid white', borderRight: '1px solid white' }}>
            <Typography variant="h5" component="div" sx={{ fontSize: '1.8rem', fontFamily: 'Gentium Plus', color: 'white', marginBottom: '1.3rem' }}>
                Sección Pacientes
            </Typography>
...
export const cardJuegos = (
    <React.Fragment>
        <CardContent sx={{ backgroundColor: '#2f5496', borderTop: '1px solid white', borderLeft: '1px solid white', borderRight: '1px solid white' }}>
            ...
            <Typography variant="body2" sx={{ fontSize: '1.1rem', fontFamily: 'Gentium Plus', color: 'white' }}>
                Conozca los juegos disponibles en la app móvil para el entrenamiento de la memoria de trabajo
            </Typography>
        </CardContent>
        <CardActions sx={{ backgroundColor: '#2f5496', fontFamily: 'Gentium Plus', color: 'white', borderBottom: '1px solid white', borderLeft: '1px solid white', borderRight: '1px solid white' }}>
...
export const cardPlataforma = (
    <React.Fragment >
        <CardContent sx={{ backgroundColor: '#2f5496', borderTop: '1px solid white', borderLeft: '1px solid white', borderRight: '1px solid white' }}>
            ...
            <Typography variant="body2" sx={{ fontSize: '1.1rem', fontFamily: 'Gentium Plus', color: 'white' }}>
                Si tiene dudas sobre cómo utilizar la plataforma, aquí encontrará información que necesita
            </Typography>
        </CardContent>
        <CardActions sx={{ backgroundColor: '#2f5496', fontFamily: 'Gentium Plus', color: 'white', borderBottom: '1px solid white', borderLeft: '1px solid white', borderRight: '1px solid white' }}>
                    ...
                    <Card variant="outlined"
                        sx={{
                            ...
                            '&:hover': {
                                ...
                                boxShadow: '0px 5px 10px rgba(0, 0, 0, 0.2), 0px 8px 16px rgba(0, 0, 0, 0.1)',
